...
import com.example.test.attempt.enums.PauseRequestStatus;
...
/**
 * A request to pause a live attempt, and its approval. {@link com.example.test.proctoring.enums.ProctoringEventType}
