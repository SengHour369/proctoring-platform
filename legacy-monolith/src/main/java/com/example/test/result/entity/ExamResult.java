package com.example.test.result.entity;

import com.example.test.attempt.entity.ExamAttempt;
import com.example.test.common.entity.BaseEntity;
import com.example.test.exam.entity.Exam;
import com.example.test.exam.enums.GradingMode;
import com.example.test.result.enums.IntegrityStatus;
import com.example.test.result.enums.ResultStatus;
