...
public class ProctoringPolicy {
    ...
    /** Seconds of video/audio captured before a triggering event, when evidence is recorded. */
    @Column(name = "evidence_capture_pre_seconds")
    private Integer evidenceCapturePreSeconds;

    /** Seconds of video/audio captured after a triggering event, when evidence is recorded. */
    @Column(name = "evidence_capture_post_seconds")
    private Integer evidenceCapturePostSeconds;
}
